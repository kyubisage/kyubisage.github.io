...
const POEM_CATEGORIES = ['all', 'desire', 'longing', 'devotion', 'fire', 'darkness'];
const POEM_CATEGORY_LABELS = {
    all: 'All',
    desire: 'Desire',
    longing: 'Longing',
    devotion: 'Devotion',
...
// ─── POETRY SECTION ────────────────────────────────────────────────
let activePoemCategory = 'all';
function renderPoemLines(lines) {
    return lines.map(line => line === '' ? '<br>' : `<p>${line}</p>`).join('');
}
...
function applyPoemFilter(category) {
